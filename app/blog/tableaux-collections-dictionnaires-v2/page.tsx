  ...
  return (
    ...
    >
      ...
      <g transform="translate(24,24)">
        <rect width="200" height="78" rx="10" fill="rgba(255,255,255,0.06)" stroke="rgba(255,255,255,0.15)" />
        {[0, 1, 2].map((r) => (
          <rect
            key={r}
            x="10"
      ...
      <g transform="translate(240,24)">
        <rect width="170" height="78" rx="10" fill="rgba(255,255,255,0.06)" stroke="rgba(255,255,255,0.15)" />
        {[0, 1, 2, 3].map((i) => (
          <circle
            key={i}
            cx={24 + i * 35}
      ...
      <g transform="translate(430,24)">
        <rect width="186" height="78" rx="10" fill="rgba(255,255,255,0.06)" stroke="rgba(255,255,255,0.15)" />
        {[0, 1, 2].map((i) => (
...
function CodeBlock({
  ...
  return (
    <pre className="mt-4 overflow-x-auto rounded-xl border border-slate-800 bg-slate-900/70 p-4 text-sm">
    ...
    <article className="container pt-10">
      ...
      <header className="grid gap-6 md:grid-cols-5">
        <div className="md:col-span-3">
          <p className="text-sm text-slate-400">20 octobre 2025 · DELGERY Sébastien</p>
      ...
      <section className="prose prose-invert mt-10">
        <p>
          ...
          perde entre indices, clés et typages. Voici un rappel clair pour choisir la bonne, au bon moment.
        </p>
      </section>
...
Debug.Print arr(2)    ' → VBA`}
        ...
        <div className="grid md:grid-cols-2 gap-4 mt-4">
          <div className="card p-4">
            ...
            <ul className="mt-2 list-disc list-inside text-slate-300 space-y-1">
              ...
              <li>Compatible avec <code>Range.Value</code></li>
            </ul>
          </div>
          <div className="card p-4">
      ...
      {/* 2. Collection */}
      <section className="mt-10">
        <h2 className="text-2xl font-semibold">📦 2. La collection — souple, simple, sans clé explicite</h2>
        <p className="mt-2 text-slate-300">
...
Debug.Print c("Auteur")`}
        ...
        <div className="grid md:grid-cols-2 gap-4 mt-4">
          ...
          <div className="card p-4">
            <h3 className="font-semibold">⚠️ Limites</h3>
            <ul className="mt-2 list-disc list-inside text-slate-300 space-y-1">
              <li>Pas de <code>.Exists</code> natif</li>
      ...
      {/* 3. Dictionary */}
      <section className="mt-10">
        <h2 className="text-2xl font-semibold">🧠 3. Le dictionnaire — rapide, structuré, clé → valeur</h2>
        <p className="mt-2 text-slate-300">
...
Next`}
        ...
        <div className="mt-8 card p-0 overflow-hidden">
          <div className="px-6 pt-6">
            <h3 className="font-semibold">⚙️ Tableau vs Collection vs Dictionary — le comparatif</h3>
          </div>
...
Debug.Print col("Profil")("Nom")`}
      ...
      <section className="mt-10">
        <div className="card p-6">
          ...
          <ul className="mt-2 list-disc list-inside text-slate-300 space-y-1">
            <li><strong>Tableau</strong> → performance brute</li>
            <li><strong>Collection</strong> → souplesse sans prise de tête</li>
            <li>
              <strong>Dictionary</strong> → structure clé/valeur, parfait pour anonymisation, mapping,
              caches, agrégations
            </li>
          </ul>
          <p className="mt-3 text-slate-300">
            Et comme toujours en VBA : commence simple, optimise plus tard. Le bon conteneur est celui
            qui éclaire ton code, pas celui qui impressionne ton compilateur.
          </p>
        </div>
        <p className="mt-4 text-sm text-slate-400">
          Article rédigé par <strong>DELGERY Sébastien</strong> — Consultant PPM &amp; BI / Développeur VBA &amp; .NET.
        </p>
      </section>
    </article>
  );
